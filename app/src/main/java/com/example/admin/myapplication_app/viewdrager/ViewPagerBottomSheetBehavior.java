...
public class ViewPagerBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    /**
     * A utility function to get the {@link com.example.admin.myapplication_app.viewdrager.ViewPagerBottomSheetBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link com.example.admin.myapplication_app.viewdrager.ViewPagerBottomSheetBehavior}.
     * @return The {@link com.example.admin.myapplication_app.viewdrager.ViewPagerBottomSheetBehavior} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> com.example.admin.myapplication_app.viewdrager.ViewPagerBottomSheetBehavior<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof com.example.admin.myapplication_app.viewdrager.ViewPagerBottomSheetBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with ViewPagerBottomSheetBehavior");
        }
        return (com.example.admin.myapplication_app.viewdrager.ViewPagerBottomSheetBehavior<V>) behavior;
    }
